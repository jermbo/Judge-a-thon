...
module.exports = () => {
    const config = {
        html: {
            source: `${env.srcPath}/**/*.{html,htm,php,pug,cshtml}`,
            lintPath: `${env.srcPath}/`,
            build: `${env.buildPath}/`
        },
        styles: {
            source: `${env.srcPath}/styles/sass/**/*.{scss,sass,css}`,
            lintPath: `${env.srcPath}/styles/sass/`,
            build: `${env.buildPath}/styles/build`
        },
        scripts: {
            source: `${env.srcPath}/scripts/src/**/*.js`,
            lintPath: `${env.srcPath}/scripts/src/`,
            build: `${env.buildPath}/scripts/build`
        },
        images: {
            source: `${
                env.srcPath
